...
public class DbConnectivityClass {
    final static String DB_NAME="CSC311DB";
        ...
        final static String SQL_SERVER_URL = "jdbc:mysql://comp123.mariadb.database.azure.com/";//update this server name
        final static String DB_URL = "jdbc:mysql://comp123.mariadb.database.azure.com/"+DB_NAME;//update this database name
        final static String USERNAME = "computer@comp123";// update this username
        final static String PASSWORD = "Nassau_123";// update this password
